        ...
        <div class="col-xs-12">
            <div class="box box-primary">
                <div class="box-header with-border ui-sortable-handle" style="cursor: move;">
                    <h3 class="box-title">
                        <i class="fa fa-lock"></i>&nbsp; Daftar Perizinan
                    </h3>
                ...
                <div class="box-body" style="overflow: auto;white-space: nowrap;width: 100%;">
                    <table id="dataPermissions" class="table table-hover table-bordered table-striped">
                        <thead>
                            <tr>
...
@include('pengaturan.perizinan._modal')
@endsection
...
<script src="{{ asset('js/perizinan_index.js') }}"></script>
@endpush