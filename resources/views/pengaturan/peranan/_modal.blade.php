    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 5px;">
            ...
            <div class="modal-body">
                <div class="mb-10">
                    <label class="mb-0">Peranan</label>
                    <input type="text" class="form-control" name="peranan_add" id="peranan_add">
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 5px;">
            ...
            <div class="modal-body">
                <div class="mb-10">
                    <label class="mb-0">Peranan</label>
                    <input type="text" class="form-control" name="peranan" id="peranan">
